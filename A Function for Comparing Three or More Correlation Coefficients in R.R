...
Practice_Data_Frame <- data.frame(Name = sample(LETTERS[1:5], 5), Coefficient_of_Correlation = sample(seq(-0.999, 0.999, length.out = 1000), 5), Sample_Size = sample(10:100, 5))
