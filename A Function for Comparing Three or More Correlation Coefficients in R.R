...
Comparing_Correlation_Coefficients <- function (Correlation_Coefficients, Numbers_of_Observations, Identifiers, Data_Frame, Alpha = 0.05, Control_for_Experimentwise_Error = TRUE) {
  ...
  return (Correlation_Coefficient_Separation_Test_Results <- list(Pairwise_Comparison_Data_Frame = Pairwise_Comparison_Data_Frame, Separation_Lettering_Data_Frame = Separation_Lettering_Data_Frame))
}
...
Output_Data_1 <- Comparing_Correlation_Coefficients(Coefficient_of_Correlation, Sample_Size, Name, Practice_Data_Frame)
Output_Data_1$Pairwise_Comparison_Data_Frame
Output_Data_1$Separation_Lettering_Data_Frame
Output_Data_2 <- Comparing_Correlation_Coefficients(Practice_Data_Frame$Coefficient_of_Correlation, Practice_Data_Frame$Sample_Size, Practice_Data_Frame$Name)
Output_Data_2$Pairwise_Comparison_Data_Frame
Output_Data_2$Separation_Lettering_Data_Frame
